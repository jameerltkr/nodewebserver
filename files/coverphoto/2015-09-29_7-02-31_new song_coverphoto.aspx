        ...
        <center>
            <div style="width: 960px;">
                <div class="width100percent main" id="mains" style="width: 101%; background-color: #cccccc !important;">
                    <div class="maindiv" style="width: 477px; height: 1080px; float: left; display: block;
                        ...
                        <div class="width100percent" style="width: 467px; float: left; display: block; margin: 10px 0 5px 10px;">
                            <div class="width50percent floatLeft lefttextalign ">
                                <div class="width100percent floatLeft lefttextalign ">
                                    <div class="width100percent floatLeft lefttextalign ">
                                        ...
                                        <div class="width50percent floatLeft lefttextalign ">
                                            <label class="fontbold">
                                                Location</label><br />
                                            <cc2:OboutDropDownList ID="ddl_FKLocationID" Width="115" runat="server" DataTextField="Name_Code_Combo"
                                ...
                                <div class="width100percent floatLeft lefttextalign ">
                                    <div class="width30percent floatLeft lefttextalign">
                                        ...
                                        <cc2:OboutDropDownList ID="ddl_FKEmployee1ID" Width="80" runat="server" DataTextField="Name_Code_Combo"
                                    ...
                                    <div class="width70percent  righttextalign">
                                        ...
                                        <cc2:OboutDropDownList ID="ddl_FKCompany1ID" Width="140" runat="server" DataTextField="Name_Code_Combo"
                                ...
                                <div class="width100percent floatLeft lefttextalign " style="margin-top: 10px">
                                    <div class="width30percent floatLeft lefttextalign">
                                        <label class="fontbold">
                                            Coach ID</label><br />
                                        <cc2:OboutDropDownList ID="ddl_FKEmployee2ID" Width="80" runat="server" DataTextField="Name_Code_Combo"
                                            DataValueField="PKEmployeeID" Height="400px">
                                        </cc2:OboutDropDownList>
                                    </div>
                                    <div class="width70percent righttextalign">
                                        ...
                                        <cc2:OboutDropDownList ID="ddl_FKCompany2ID" Width="140" runat="server" DataTextField="Name_Code_Combo"
                                            DataValueField="PKCompanyID" Height="400px">
                                        </cc2:OboutDropDownList>
                                    </div>
                                </div>
                                <div class="width100percent floatLeft lefttextalign" style="margin-top:10px">
                                    <label class="fontbold">
                                        Plant</label><br />
                                    <cc2:OboutDropDownList ID="ddl_FKAreaID" Width="230" runat="server" DataSourceID="SqlDataSourceArea"
                            ...
                            <div class="width50percent floatLeft lefttextalign ">
                                <div class="width100percent floatLeft lefttextalign ">
                                    <div class="width100percent floatLeft lefttextalign ">
                                        <asp:RadioButtonList onmousedown="getSelected(this);" Width="100%" onClick="unselectkRest(this);"
                                            RepeatDirection="Horizontal" ID="lst_Shift" runat="server">
                                ...
                                <div class="width100percent floatleft lefttextalign">
                                    <asp:RadioButtonList onmousedown="getSelected(this);" RepeatColumns="2" onClick="unselectkRest(this);"
                                        RepeatDirection="Horizontal" ID="lst_Operations" runat="server">
                                ...
                                <div class="width100percent floatleft lefttextalign">
                                    <asp:RadioButtonList onmousedown="getSelected(this);" onClick="unselectkRest(this);"
                                        RepeatColumns="2" RepeatDirection="Horizontal" ID="lst_Observation_Type" runat="server">
                    ...
                    <div class="maindiv" style="width: 485px; height: 1090x; float: left; background: #fff;
                        ...
                        <div class="leftdiv" style="width: 477px; margin: 0 0 0 10px;">
